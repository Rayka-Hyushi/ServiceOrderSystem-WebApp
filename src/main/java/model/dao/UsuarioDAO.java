...
public class UsuarioDAO {
    ...
    public Usuario read(int id) {
        ...
        try {
            stmt = con.prepareStatement("select id, nome, foto_perfil from usuario where id = ?");
            stmt.setInt(1, id);
    ...
    public Usuario login(String email, String password) {
        ...
        Usuario usuario = new Usuario();
        try {
            stmt = con.prepareStatement("select id, nome, email, senha, foto_perfil from usuario");
            rs = stmt.executeQuery();
