                        ...
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <c:forEach var="cliente" items="${clientes}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="clientes?action=editar&idcliente=${cliente.idcliente}" class="btn btn-sm btn-warning">Editar</a>
                                        <a href="clientes?action=excluir&idcliente=${cliente.idcliente}" class="btn btn-sm btn-danger">Excluir</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
